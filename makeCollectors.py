...
print("#define SEND_INTERVAL		(60 * CLOCK_SECOND)")
...
print("    if(addr != NULL) {")
print("      static unsigned int message_number;")
print("      char buf[20];\n")
print("      printf(\"Sending unicast to \");")
print("      uip_debug_ipaddr_print(addr);")
print("      message_number = random_rand() \% %d;" % (size))
print("      sprintf(buf, \"Message %d\", message_number);")
